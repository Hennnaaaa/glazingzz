          ...
          <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
            ...
            >
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6">
                Our Professional
                <span className="block text-slate-300">Glazing Services</span>
              </h1>
              <p className="text-xl md:text-2xl text-slate-200 mb-8 max-w-3xl mx-auto leading-relaxed">
                From windows and doors to complete glazing solutions - discover our comprehensive range of professional services designed to transform your property.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a 
                  href="#services-section"
                  className="bg-slate-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-slate-700 transition-all duration-300 text-lg"
                >
                  Explore Services
                </a>
                <a
                  href="/contact"
                  className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-slate-600 transition-all duration-300 text-lg"
                >
                  Get Free Quote
                </a>
              </div>
